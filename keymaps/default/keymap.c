...
//    │     │      │       │      │      │         │               │      │      │      │      │      │      │
//    ├─────┼──────┼───────┼──────┼──────┼─────────┤               ├──────┼──────┼──────┼──────┼──────┼──────┤
//    │     │ ins  │ nXTWD │ end  │  no  │   no    │               │ C(c) │ pgup │ home │ ent  │ C(v) │ bspc │
//    ├─────┼──────┼───────┼──────┼──────┼─────────┤               ├──────┼──────┼──────┼──────┼──────┼──────┤
//    │     │ end  │ lctl  │ pgdn │  no  │ CW_TOGG │               │ left │ down │  up  │ rght │ del  │ bspc │
//    ├─────┼──────┼───────┼──────┼──────┼─────────┼─────┐   ┌─────┼──────┼──────┼──────┼──────┼──────┼──────┤
...
[_RAISE] = LAYOUT(
  ...
  _______ , KC_INS  , KC_NXTWD , KC_END  , XXXXXXX , XXXXXXX  ,                         C(KC_C) , KC_PGUP , KC_HOME , KC_ENT  , C(KC_V) , KC_BSPC,
  _______ , KC_END  , KC_LCTL  , KC_PGDN , XXXXXXX , CW_TOGG  ,                         KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_DEL  , KC_BSPC,
